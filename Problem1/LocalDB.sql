CREATE DATABASE  IF NOT EXISTS `a2_locb00923816` /*!40100 DEFAULT CHARACTER SET utf8mb3 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `a2_locb00923816`;
-- MySQL dump 10.13  Distrib 8.0.31, for macos12 (x86_64)
--
-- Host: 127.0.0.1    Database: a2_locb00923816
-- ------------------------------------------------------
...
INSERT INTO `park` VALUES (1,'Halifax public park',1200,'1333, South park Street','7 am to 7 pm');
...
CREATE TABLE `park_has_events` (
  ...
  CONSTRAINT `fk_park_has_events_events1` FOREIGN KEY (`events_event_id`) REFERENCES `events` (`event_id`),
...
INSERT INTO `visitors` VALUES (1,'Khushi Hiren Shah','9029941301','2022-10-24');
...
-- Dump completed on 2022-10-28 10:32:46
